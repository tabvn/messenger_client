    ...
    return (
      !sidebarIsOpen ?
        <Container
          ...
          <Button onClick={() => this.handleCreateGroup()} className={'create-group-conversation'}><i
            className={'md-icon md-24'}>group</i></Button>
          <Button onClick={() => {
            this.props.toggleSidebar(true)
          }} className={'create-group-conversation'}><i className={'md-icon md-24'}>search</i></Button>
        </Container> : null
    )
  }
}
